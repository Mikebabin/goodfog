...
reports the tests passing (expect "64 passed" for the backend and "11 passed" for the
frontend), you're set up.
...
Open the URL it gives you (normally http://localhost:5173). You should see the SF map.
...
- Ask Claude to explain anything — "explain how the temperature fusion works" or
  "what does this PR change?" are good questions.
...
| What | Where |
|---|---|
| Design decisions | `docs/superpowers/specs/2026-08-28-goodfog-design.md` |
| Backend (Python/FastAPI) | `backend/` |
| Frontend (Svelte) | `frontend/` |
| Neighborhood shapes | `data/` (generated by `scripts/build_geo.py`) |
