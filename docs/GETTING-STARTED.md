...
reports all tests pass (currently 72 backend, 27 frontend), you're set up.
...
| Coastline for the map | `data/coast.geojson` (generated by `scripts/build_geo.py`; never hand-edit) |
